...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/common/css/bootstrap.min.css">
            ...
            <section id="drawer_content">
                <section class="container-fluid">
                    <section class="row g-0 align-items-center">
                        <section class="col">
                            <a id="brand_drawer" href="<?php echo get_home_url(); ?>" aria-label="<?php bloginfo('name'); ?>"><?php get_template_part( 'inc/brand' ); ?></a>
                        </section><!--col-->
                        <section class="col-auto ms-auto d-xxl-none">
                            <button class="hamburger" aria-label="Menu">
                                <svg xmlns="http://www.w3.org/2000/svg" width="29" height="11" viewBox="0 0 29 11">
                                    <path class="close" fill-rule="evenodd" d="M0 5h29v1H0V5Z" clip-rule="evenodd"/>
                                </svg>
