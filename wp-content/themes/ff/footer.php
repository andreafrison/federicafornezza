    ...
    <footer id="footer">
        <section class="container-fluid">
            <section class="row gy-5">
                <section class="col">
                    <a id="footer_brand" href="<?php echo get_home_url(); ?>" aria-label="<?php bloginfo('name'); ?>"><?php get_template_part( 'inc/brand' ); ?></a>
                    <div class="footer-text mt-4"><?php the_field('footer_text','option'); ?><br><br><a href="<?php the_permalink(3); ?>">Privacy Policy</a> &middot; <a href="<?php the_permalink(9); ?>">Cookie Policy</a></div>
                </section><!--col-->
